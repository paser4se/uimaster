	...
	public void updateCustLinks(List<String> links) {
		...
		try {
			...
			for (String item : links) {
				html.append("<span class=\"swiper-slide\" style=\"background-image:url(" + item + ")\" img=\"" + item
						+ "\"/></span>");
			}
			html.append("</div>");
			...
			if (isgallery) {
				...
				if (directory.exists()) {
					...
					for (String i : images) {
						...
						html.append("<span class=\"swiper-slide\" style=\"background-image:url(" + item + ")\" img=\""
								+ item + "\"/></span>");
					}
				}
				html.append("</div>");
			...
			if (directory.exists() && directory.list() != null) {
				...
				for (String i : images) {
					...
					if (f.isFile()) {
						...
						sb.append("<span class=\"swiper-slide\" style=\"background-image:url(" + item + ")\" alt=\"" + i
								+ "\" img=\"" + item + "\"/></span>");
					}
				}
				sb.append("</div>");
