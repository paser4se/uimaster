...
public class TaskHistoryImpl  implements org.shaolin.bmdp.workflow.be.ITaskHistory
{
    ...
    {
        return "org.shaolin.bmdp.workflow.be.TaskHistory";
    }
   ...
   /**
     *  help is not available
     */    
    protected java.lang.String executedNode;
   ...
   /**
    ...
    public boolean equals(Object obj) {
        if (obj == this)
            return true;
        if (!(obj instanceof org.shaolin.bmdp.workflow.be.TaskHistoryImpl))
            return false;
        org.shaolin.bmdp.workflow.be.TaskHistoryImpl o = (org.shaolin.bmdp.workflow.be.TaskHistoryImpl)obj;
    ...
    public  String  toString() {
        ...
        aBuf.append("org.shaolin.bmdp.workflow.be.TaskHistory");
    ...
    public List<MemberType> getMemberList() {
        ...
        org.shaolin.bmdp.datamodel.bediagram.StringType executedNodeBEType = new org.shaolin.bmdp.datamodel.bediagram.StringType();
    
        //MemberType Define for executedNode
        member = new MemberType();
        member.setName("executedNode");
        member.setDescription("null");
        member.setType(executedNodeBEType);
        memberTypeList.add(member);
    ...
    public ITaskHistory createEntity ()
    {
        return new TaskHistoryImpl();
    }
