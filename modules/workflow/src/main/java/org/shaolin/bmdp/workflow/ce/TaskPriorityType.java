 ...
 * Generated on Fri Mar 11 00:00:41 CST 2016
 */
...
/**
 * 
 * entityName: org.shaolin.bmdp.workflow.ce.TaskPriorityType
 *
 */
public final class TaskPriorityType extends AbstractConstant
{
    public static final String ENTITY_NAME = "org.shaolin.bmdp.workflow.ce.TaskPriorityType";
    ...
    public static final TaskPriorityType LOW = new TaskPriorityType("Low", 0, "org.shaolin.bmdp.workflow.ce.TaskPriorityType.LOW", "Low", null, null,false);

    public static final TaskPriorityType NORMAL = new TaskPriorityType("Normal", 1, "org.shaolin.bmdp.workflow.ce.TaskPriorityType.NORMAL", "Normal", null, null,false);

    public static final TaskPriorityType HIGH = new TaskPriorityType("High", 2, "org.shaolin.bmdp.workflow.ce.TaskPriorityType.HIGH", "High", null, null,false);

    public static final TaskPriorityType CRITICAL = new TaskPriorityType("Critical", 3, "org.shaolin.bmdp.workflow.ce.TaskPriorityType.CRITICAL", "Critical", null, null,false);
