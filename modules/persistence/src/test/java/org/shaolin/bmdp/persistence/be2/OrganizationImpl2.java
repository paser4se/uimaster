...
public class OrganizationImpl2 
         implements IOrganization
{
   ...
   /**
    ...
    public boolean equals(Object obj) {
        if (obj == this)
            return true;
        if (!(obj instanceof OrganizationImpl2))
            return false;
        OrganizationImpl2 o = (OrganizationImpl2)obj;
