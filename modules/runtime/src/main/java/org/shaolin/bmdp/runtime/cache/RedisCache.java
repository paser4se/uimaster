...
class RedisCache implements ICache<String, String> {
	...
	public RedisCache(final String cacheName, final Jedis jedis) {
		this.name = cacheName;
		this.jedis = jedis;
	}
	...
	public String get(String key) {
		...
		String v = jedis.get(this.name + key);
        if (v != null) {
	...
	public String put(String key, String value) {
		...
		jedis.set(this.name + key, value.toString());
		return value;
	}
