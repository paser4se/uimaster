    ...
    private void generateConstantEntity(ConstantEntityType constantEntity, File rootDir)
    {
        ...
        for(ConstantValueType constantValue: constantValues)
        {
            ...
            if (!hasPriority)
            {
		        ...
		        out.print(constantEntityName);
		        out.write("(\"");
		        out.print(StringUtil.string2Unicode(constantValue.getValue().trim()));
		        out.write("\", ");
		        out.print(intValue);
		        out.write(", ");
		        out.print(i18nKey);
		        out.write(", ");
		        out.print(StringUtil.string2Unicode(description));
		        out.write(", ");
		        out.print(effTime);
		        out.write(", ");
		        out.print(expTime);
            ...
            else
            {
		        ...
		        out.print(constantEntityName);
		        out.write("(");
		        out.print(StringUtil.string2Unicode(value.trim()));
		        out.write(", ");
		        out.print(intValue);
		        out.write(", ");
		        out.print(i18nKey);
